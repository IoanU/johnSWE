...
Free resources for learning cloud fundamentals and getting hands-on experience with the major cloud ecosystems.
...
Start with IAM, networking, compute, storage, managed databases, observability, infrastructure as code, and the shared-responsibility model. Learn the concepts first; provider-specific service names are much easier afterwards.
