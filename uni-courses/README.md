...
Free university-level computer-science material for learning subjects in a more structured and rigorous way.

## Resources

| Resource | Best for |
| --- | --- |
| [MIT OpenCourseWare](https://ocw.mit.edu/) | Free lecture notes, assignments, exams, and course materials across computer science and engineering. |
| [Harvard CS50](https://pll.harvard.edu/course/cs50-introduction-computer-science) | A polished introduction to computer science, programming, algorithms, memory, data structures, and web development. |
