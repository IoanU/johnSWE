...
Resources for understanding C execution, memory, pointers, and the lower-level behavior that makes the language useful for systems programming.
...
Pay special attention to memory layout, pointer arithmetic, arrays vs. pointers, object lifetime, undefined behavior, compilation/linking, the C standard library, and OS-facing APIs.
