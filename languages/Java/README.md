...
Resources for learning Java syntax, object-oriented design, the JVM ecosystem, and the concurrency concepts that matter in production and interviews.
...
Prioritize the type system, collections, generics, exceptions, streams, JVM memory, garbage collection, threads, `synchronized`, `volatile`, locks, executors, and the Java Memory Model.
